...
const GetStarted = () => {
  return (
    // bg-[#1d2130]
    <section className="container  text-white w-fit max-w-full h-[480px] md:h-[330px]  pt-10 bg-[#22283c] rounded-[5px] ">
      ...
      <form className="flex mx-auto items-center gap-10 my-10 max-w-full flex-col md:flex-row  w-[1000px]">
        <input
          type="email"
          className="rounded-[30px] outline-none border-none ml-10 px-5 w-full md:w-[600px] h-[60px] font-bold text-black"
        />
        <button
          type="submit"
